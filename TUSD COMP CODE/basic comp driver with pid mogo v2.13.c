...
#pragma config(Sensor, in3,    potleftlift,    sensorPotentiometer)
...
//Arm Postitions
/////////////////////
const int armPos[9] = {0, 450, 433, 413, 412, 393, 380, 350, 380}
#define zeroA 0
#define oneA 0
#define twoA 0
#define threeA 0
...
{
PID armController;
initPID(armController, 0.29, 0.0, 0.5);
...
controller.Error = targetDrivePos - in;
...
while(true)
{
	int drivePowerL = drivePIDCalculation(drivePosTarget, driveController, SensorValue[encLeft]);
	int drivePowerR = drivePIDCalculation(drivePosTarget, driveController, SensorValue[encRight]);
