...
void skills()
{
	...
	driveTurn(targetHeading-1173, -1700);
	clearDriveEnc();
	...
	driveKeepHeading(1650, targetHeading, -1500, 30);
	...
	driveKeepHeading(2700);

	driveTurn(targetHeading-152);
	clearDriveEnc();
	...
	driveKeepHeading(1400);
	startTask(mogoDownTask);
	driveKeepHeading(1700);
	drive(-127, -40);
