void skills()
{
	...
	driveTurn(targetHeading, 300, 0.65, 500, true);
	...
	driveTurn(targetHeading, 1000, 0.55, 1000, true);
	...
	driveKeepHeading(-20); // robot backwards
	...
	driveTurn(targetHeading+450, 2000, 0.45, 1000);
	clearDriveEnc();

	driveKeepHeading(-800);

	driveTurn(targetHeading-1800, 1500, 0.35, 1000);
	clearDriveEnc();
	...
	driveTurn(targetHeading+900, 1500, 0.35, 1000);
	clearDriveEnc();
	...
	//driveTurn(targetHeading+1800, 1500, 0.4, 1000);
	//clearDriveEnc();
