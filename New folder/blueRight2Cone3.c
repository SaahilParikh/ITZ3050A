...
const int mogoPos[9] = {315, 1450, 1450, 1500, 1600, 1790, 1790, 2380, 2500};
const int armPos[9] = {   0,  410,  395,  350,  350,  350,  350,  335,  310};
...
while(driveRightEnc > 300)
{
}

while(abs(nMotorEncoder[liftLeft]) > 300)
{
}
...
wait1Msec(1100);
clearDriveEnc();
drivePosTarget = -550; // drive to cone
wait1Msec(600);
